          ...
          {TEAM.map((member, i) => (
            ...
            >
              ...
              <div className="text-center space-y-1">
                <h3 className="text-xl font-bold group-hover:text-violet-400 transition-colors">{member.name}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {[
                  { label: "Email Us", value: "hello@veriscribe.ai", icon: Mail, color: "text-violet-400", hover: "group-hover:bg-violet-600" },
                  { label: "Visit Us", value: "San Francisco, CA", icon: MapPin, color: "text-emerald-400", hover: "group-hover:bg-emerald-600" }
                ].map((item, i) => (
                  <motion.div 
                    key={i}
                    whileHover={{ x: 10 }}
                  ...
                  >
                    <div className={cn("w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center transition-all", item.color, item.hover, "group-hover:text-white")}>
                      <item.icon className="w-5 h-5" />
                    </div>
                    <div>
                      <p className="text-xs font-bold text-white/20 uppercase tracking-widest">{item.label}</p>
