...
export function CinematicHero({ 
  ...
  tagline2 = "one doc at a time.",
  cardHeading = "Intelligence, redefined.",
  cardDescription = <><span className="text-white font-semibold">Veriscribe</span> bridges the gap between artificial intelligence and human creativity, providing absolute clarity, authenticity, and precision.</>,
  metricValue = 50,
  metricLabel = "Million Docs",
  ctaHeading = "Experience Veriscribe.",
  ctaDescription = "Join thousands of researchers, students, and professionals elevating their writing standard.",
  showCTA = true,
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      introTl
        ...
        .to(".text-days", { duration: 1.4, autoAlpha: 1, clipPath: "inset(0 0% 0 0)", ease: "power4.inOut" }, "-=1.0");

      const scrollTl = gsap.timeline({
        scrollTrigger: {
          trigger: containerRef.current,
          start: "top top",
          end: showCTA ? "+=5000" : "+=1800", // Snappy scroll transition if no CTA!
          pin: true,
          scrub: 1,
          anticipatePin: 1,
        },
      ...
      // Cinematic Overlap Orchestrator: Elements glide in simultaneously as the card raises & stretches!
      scrollTl
        .to([".hero-text-wrapper", ".bg-grid-theme"], { scale: 1.15, filter: "blur(20px)", opacity: 0.2, ease: "power2.inOut", duration: 2 }, 0)
        .to(".main-card", { y: 0, ease: "power3.inOut", duration: 2 }, 0)
        .to(".main-card", { width: "100%", height: "100%", borderRadius: "0px", ease: "power3.inOut", duration: 1.5 }, "-=0.5")
        
        // Mockup and card overlays reveal early to avoid empty black screens
        .fromTo(".mockup-scroll-wrapper",
          { y: 300, z: -500, rotationX: 50, rotationY: -30, autoAlpha: 0, scale: 0.6 },
          { y: 0, z: 0, rotationX: 0, rotationY: 0, autoAlpha: 1, scale: 1, ease: "expo.out", duration: 2.2 }, "1.0"
        )
        .fromTo(".phone-widget", { y: 40, autoAlpha: 0, scale: 0.95 }, { y: 0, autoAlpha: 1, scale: 1, stagger: 0.15, ease: "back.out(1.2)", duration: 1.5 }, "1.4")
        .to(".progress-ring", { strokeDashoffset: 60, duration: 2, ease: "power3.inOut" }, "1.6")
        .to(".counter-val", { innerHTML: metricValue, snap: { innerHTML: 1 }, duration: 2, ease: "expo.out" }, "1.0")
        .fromTo(".floating-badge", { y: 100, autoAlpha: 0, scale: 0.7, rotationZ: -10 }, { y: 0, autoAlpha: 1, scale: 1, rotationZ: 0, ease: "back.out(1.5)", duration: 1.5, stagger: 0.2 }, "1.4")
        .fromTo(".card-left-text", { x: -50, autoAlpha: 0 }, { x: 0, autoAlpha: 1, ease: "power4.out", duration: 1.5 }, "1.1")
        .fromTo(".card-right-text", { x: 50, autoAlpha: 0, scale: 0.8 }, { x: 0, autoAlpha: 1, scale: 1, ease: "expo.out", duration: 1.5 }, "1.1");
      ...
      if (showCTA) {
        ...
        // Rest on screen fully visible so page scrolls away seamlessly
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-screen h-screen overflow-hidden flex items-center justify-center bg-background text-foreground font-sans antialiased [perspective:1500px]", className)}
      {...props}
    >
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none [perspective:1500px]">
        <div
          ref={mainCardRef}
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10 [perspective:1000px]">
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">AI Detector</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Originality assured</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Humanizer</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Bypasses AI checks</p>
                  </div>
                </div>
