            ...
            <React.Fragment key={index}>
              ...
              >
                ...
                <motion.div 
                  ...
                  className="w-9 h-9 rounded-full flex items-center justify-center text-white font-bold text-base transition-all duration-200 group-hover:shadow-[0_0_15px_rgba(255,255,255,0.2)] cursor-default"
                ...
                <motion.div 
                  ...
                  className="mt-3 text-[48px] h-12 flex items-center justify-center transition-transform duration-300"
                >
                ...
                {/* Title */}
                <h3 className="text-base font-semibold text-white mt-3 group-hover:text-white transition-colors">
                  {step.title}
                </h3>

                {/* Description */}
                <p className="text-[14px] text-white/40 mt-3 max-w-[220px] group-hover:text-white/60 transition-colors">
                  {step.desc}
                </p>
              </ScrollReveal>
