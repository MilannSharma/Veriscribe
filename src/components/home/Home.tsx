...
const RecentDocuments = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8 relative z-10 -mt-10">
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="text-sm font-medium text-white/40 hover:text-white transition-colors flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {docs.map((doc, i) => (
          <div key={i} className="group relative p-4 rounded-2xl border border-white/5 bg-white/5 hover:bg-white/[0.08] transition-all cursor-pointer overflow-hidden">
                      ...
                      <div className="relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-6 group transition-all duration-300">
                        <div className="relative flex flex-1 flex-col justify-between gap-4">
                          <div className="flex items-start justify-between">
                            <div className="w-fit rounded-xl border border-white/10 bg-white/5 p-3 group-hover:scale-110 transition-transform duration-500">
...
export const Home = () => {
  return (
    <div className="relative min-h-screen">
      <HeroSection 
        title="21+ AI tools. One ecosystem."
        subtitle={{
          regular: "Write. Detect. ",
          gradient: "Humanize. Perfect."
        }}
        description="The only AI writing suite that detects, humanizes, formats, and perfects — all in one intelligent workspace."
